...
public class ReadPosSetDataType extends SetCompressor<ReadPos> implements MergeableDataType<Set<ReadPos>>
{
    public ReadPosSetDataType()
    {
        super(new ReadPosDataType());
    }
